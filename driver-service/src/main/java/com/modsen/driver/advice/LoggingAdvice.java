package com.modsen.driver.advice;
...
public class LoggingAdvice {
    @Pointcut("within(com.modsen.driver.service..*)")
    public void servicePointcut() {
    }

    @Pointcut("within(com.modsen.driver.kafka.consumer..*)")
    public void kafkaConsumerPointcut() {
    }

    @Pointcut("within(com.modsen.driver.kafka.producer..*)")
